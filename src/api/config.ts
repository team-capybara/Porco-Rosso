...
export const mockAxios = axios.create({
  ...
  headers: {
    ...
    // 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIzMSIsImlzcyI6ImNhcHliYXJhIiwicm9sZXMiOiJNRU1CRVIiLCJpYXQiOjE3MjkxNzE0MDd9.cHUz1D5cjaUlxoUg5DwFgO66tFlapJIbxdyePbbDfujklJ5qkN2bxtfYotRyXT9srG6sBlk4uVquB76g_wob8Q',
